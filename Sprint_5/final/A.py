...
# https://contest.yandex.ru/contest/24810/run-report/81155697/
'''
--Описание решения--
Соритровка основана на пирамиде, с итеративным извлечении максимального элемента
из ее вершины.

--Доказательство корректности--
Процесс разбит на 2 этапа:
* Заполнение пирамиды элемента из исходного массива. На каждой итерации новый 
элемент просеивается вверх.
* Извлечение максимального элемента из вершины пирамиды. После извлечения новый 
максимум находится через просеивание вниз последнего добавленного в пирамиду 
элемента.

--Временная сложность--
Добавление новых элементов в пирамиду - O(n*log(n))
Извлечение всех элементов с восстановлением структуры пирамиды - O(n*log(n))
Итоговая сложность - O(n*log(n))

--Пространственная сложность--
O(n) дополнительной памяти для хранения массива пирамиды
'''
